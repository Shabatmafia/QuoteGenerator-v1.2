...
Known notes: the carrier *logo image* in the page-4 tables is baked into the template and won't change with the quoted carrier (the carrier name text does change); the Named Insureds box shows the single client name.
